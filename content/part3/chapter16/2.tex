...
\multirow{2}{*}{vector} &
\multicolumn{1}{l|}{顺序} &
\multicolumn{1}{l|}{\begin{tabular}[c]{@{}l@{}}末尾时为O(1)\\ 其他情况为O(N)\end{tabular}} &
\multicolumn{1}{l|}{\begin{tabular}[c]{@{}l@{}}末尾时为O(1)\\ 其他情况为O(N)\end{tabular}} &
O(1) \\ \cline{2-5}
&
...
\multirow{2}{*}{list} &
\multicolumn{1}{l|}{顺序} &
\multicolumn{1}{l|}{\begin{tabular}[c]{@{}l@{}}开头和结尾为O(1)\\其他情况为O(N)
\end{tabular}} &
\multicolumn{1}{l|}{\begin{tabular}[c]{@{}l@{}} 开头和结尾为O(1)\\其他情况为O(N)\end{tabular}} &
\begin{tabular}[c]{@{}l@{}}访问第一个或\\最后一个元素\\为 O(1)\\其他情况为O(N)
...
\multicolumn{1}{l|}{顺序} &
\multicolumn{1}{l|}{\begin{tabular}[c]{@{}l@{}}开头处为O(1)\\其他情况为O(N)\end{tabular}} &
\multicolumn{1}{l|}{\begin{tabular}[c]{@{}l@{}}开头处为O(1)\\其他情况为O(N)\end{tabular}} &
\begin{tabular}[c]{@{}l@{}}访问第一个元素\\为 O(1)\\其他情况为O(N)\end{tabular} \\ \cline{2-5}
&
\multicolumn{4}{l|}{\begin{tabular}[c]{@{}l@{}}何时使用：很少使用。\end{tabular}} \\ \hline
\multirow{2}{*}{deque} &
\multicolumn{1}{l|}{顺序} &
\multicolumn{1}{l|}{\begin{tabular}[c]{@{}l@{}}开头或结束处为O(1)\\其他情况为O(N)\end{tabular}} &
\multicolumn{1}{l|}{\begin{tabular}[c]{@{}l@{}}开头或结束处为O(1)\\其他情况为O(N)\end{tabular}} &
O(1) \\ \cline{2-5}
&
...
\multicolumn{1}{l|}{\begin{tabular}[c]{@{}l@{}}平均为O(1)\\ 最坏情况为O(N)\end{tabular}} &
\multicolumn{1}{l|}{\begin{tabular}[c]{@{}l@{}}平均为O(1)\\ 最坏情况为O(N)\end{tabular}} &
\begin{tabular}[c]{@{}l@{}}平均为O(1)\\最坏情况为O(N)\end{tabular} \\ \cline{2-5}
&
...
本节概述了标准库中可用的算法种类，而不涉及细节，第 20 章介绍了算法选择。对于所有可用算法的原型，请查询标准库手册。
