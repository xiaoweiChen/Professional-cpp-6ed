...
\mySection{第2章}{使用字符串和字符串视图}{content/part1/chapter2/0.tex}
...
\mySection{第4章}{设计专业C++程序}{content/part2/chapter4/0.tex}
...
\mySubsection{5.1.}{否在程序性地思考?}{content/part2/chapter5/1.tex}
...
\mySubsection{15.2.}{重载算术运算符}{content/part3/chapter15/2.tex}
...
\end{comment}
\mySection{第29章}{高效编写C++}{content/part5/chapter29/0.tex}
...
\mySection{第30章}{熟练测试}{content/part5/chapter30/0.tex}
...
\mySubsection{32.1.}{总是记不住怎么……}{content/part5/chapter32/1.tex}
...
\mySubsection{A.5.}{Chapter 5: Designing with classes Reuse}{content/part6/appendix-A/5.tex}
\mySubsection{A.6.}{Chapter 6: Designing For Reuse}{content/part6/appendix-A/6.tex}
\mySubsection{A.7.}{Chapter 7: Memory Management}{content/part6/appendix-A/7.tex}
\mySubsection{A.8.}{Chapters 8 And 9: Gaining Proficiency With Classes And Objects, And Mastering Classes And Objects}{content/part6/appendix-A/8.tex}
\mySubsection{A.9.}{Chapter 10: Discovering Inheritance Techniques}{content/part6/appendix-A/9.tex}
\mySubsection{A.10.}{Chapter 11: Modules, Header Files, And Miscellaneous Topics}{content/part6/appendix-A/10.tex}
\mySubsection{A.11.}{Chapters 12 And 26: Writing Generic Code With Templates, And Advanced Templates}{content/part6/appendix-A/11.tex}
\mySubsection{A.12.}{Chapter 13: Demystifying C++ I/O}{content/part6/appendix-A/12.tex}
\mySubsection{A.13.}{Chapter 14: Handling Errors}{content/part6/appendix-A/13.tex}
\mySubsection{A.14.}{Chapter 15: Overloading C++ Operators}{content/part6/appendix-A/14.tex}
\mySubsection{A.15.}{Chapters 16–20 And 25: The Standard Library}{content/part6/appendix-A/15.tex}
\mySubsection{A.16.}{Chapter 22: Date And Time Utilities}{content/part6/appendix-A/16.tex}
\mySubsection{A.17.}{Chapter 23: Random Number Facilities}{content/part6/appendix-A/17.tex}
\mySubsection{A.18.}{Chapter 24: Additional Vocabulary Types}{content/part6/appendix-A/18.tex}
\mySubsection{A.19.}{Chapter 27: Multithreaded Programming With C++}{content/part6/appendix-A/19.tex}
\mySubsection{A.20.}{Chapter 28: Maximizing Software Engineering Methods}{content/part6/appendix-A/20.tex}
\mySubsection{A.21.}{Chapter 29: Writing Efficient C++}{content/part6/appendix-A/21.tex}
\mySubsection{A.22.}{Chapter 30: Becoming Adept At Testing}{content/part6/appendix-A/22.tex}
\mySubsection{A.23.}{Chapter 31: Conquering Debugging}{content/part6/appendix-A/23.tex}
\mySubsection{A.24.}{Chapter 32: Incorporating Design Techniques And Frameworks}{content/part6/appendix-A/24.tex}
\mySubsection{A.25.}{Chapter 33: Applying Design Patterns}{content/part6/appendix-A/25.tex}
\mySubsection{A.26.}{Chapter 34: Developing Cross-platform And Crosslanguage Applications}{content/part6/appendix-A/26.tex}
\newpage
...
\mySubsection{B.5.}{Open-source Software}{content/part6/appendix-B/5.tex}
\mySubsection{B.6.}{Software Engineering Methodology}{content/part6/appendix-B/6.tex}
\mySubsection{B.7.}{Programming Style}{content/part6/appendix-B/7.tex}
\mySubsection{B.8.}{Computer Architecture}{content/part6/appendix-B/8.tex}
\mySubsection{B.9.}{Efficiency}{content/part6/appendix-B/9.tex}
\mySubsection{B.10.}{Testing}{content/part6/appendix-B/10.tex}
\mySubsection{B.11.}{Debugging}{content/part6/appendix-B/11.tex}
\mySubsection{B.12.}{Design Patterns}{content/part6/appendix-B/12.tex}
\mySubsection{B.13.}{Operating Systems}{content/part6/appendix-B/13.tex}
\mySubsection{B.14.}{Multithreaded Programming}{content/part6/appendix-B/14.tex}
\newpage
...
\mySubsection{C.5.}{Mathematical Utilities}{content/part6/appendix-C/5.tex}
\mySubsection{C.6.}{Exceptions}{content/part6/appendix-C/6.tex}
\mySubsection{C.7.}{I/O Streams}{content/part6/appendix-C/7.tex}
\mySubsection{C.8.}{Threading Support Library}{content/part6/appendix-C/8.tex}
\newpage
